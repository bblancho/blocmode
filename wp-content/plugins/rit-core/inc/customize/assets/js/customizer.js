(function ($) {
    ...
    $(document).ready(function() {
        ...
        $( '.customize-control-image_selector label img' ).click(function() {
            $(this).prev().prop('checked');
            $(this).closest('.customize-control-image_selector').find('label').removeClass('selected');
            $(this).closest('label').addClass('selected');
        });

        // Input layout
        $( '.customize-control-image_selector input:radio' ).change( function () {
        ...
        controlSlider.each( function() {
            var inputField = $(this).find( '.rit-slider-range-input' ),
                sliderRange = $(this).find( '.rit-slider-range' );

            $(this).find('.rit-slider-range').slider({
                range: "min",
       ...
       $( '.rit-slider-range-input' ).on( 'keyup paste', function() {
            $(this).change();
        ...
        $( '.rit-slider-range-input' ).on( 'change', function() {
