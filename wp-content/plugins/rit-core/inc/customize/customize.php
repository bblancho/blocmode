...
require_once('classes/customize-image-selector.php');
...
require_once('classes/customize-toggle.php');
require_once('classes/customize-slider.php');
require_once('classes/customize-info.php');
