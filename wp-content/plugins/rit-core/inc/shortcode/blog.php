            ...
            "params" => array(
                ...
                array(
                    ...
                    "value" => array(
                        ...
                        esc_html__('Grid 2', 'rit-core-language' ) => 'grid-no-thumb',
                        esc_html__('List', 'rit-core-language' ) => 'list',
                        esc_html__('List Only Title', 'rit-core-language' ) => 'list-title',
                    ),
                ...
                array(
                    'type' => 'checkbox',
                    'heading' => esc_html__("Enable Border", 'rit-core-language'),
                    'param_name' => 'enable_border',
                    'group'=>esc_html__('Layout','rit-core-language'),
                    'std' => 'yes',
                    'dependency' => Array('element' => 'layout', 'value' => array('grid-no-thumb')),
