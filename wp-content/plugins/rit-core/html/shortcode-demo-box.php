                    ...
                    if ($atts['text_link'] != '') {
                        ...
                        <a href="<?php echo esc_url($atts['link']); ?>" class="btn btn-view"
                           title="<?php echo esc_attr($atts['title']) ?>">
                            <?php echo($atts['text_link'] != '' ? esc_html($atts['text_link']) : esc_html__('View Demo', 'rit-core-language')); ?>
                        </a>
                    <?php }
                } else {
                    echo esc_html__('Coming soon', 'rit-core-language');
                } ?>
            </div>
            <?php if ($atts['hot_label'] != '') { ?><span
                class="circus-box primary-font hot-label"><?php echo esc_html__('Hot', 'rit-core-language'); ?></span>
            <?php }
            if ($atts['new_label'] != '') { ?><span
                class="circus-box primary-font new-label"><?php echo esc_html__('New', 'rit-core-language'); ?></span>
