...
<div class="row">
                ...
                <div class="share-links">
                    ...
                    <ul class="social-icons">
                        <li class="facebook social-icon"><a
                                href="http://www.facebook.com/sharer.php?u=<?php echo esc_url(the_permalink($atts['shortcode'])); ?>"
                                class="post_share_facebook" onclick="javascript:window.open(this.href,
                      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=220,width=600');return false;"><i
                                    class="fa fa-facebook-f"></i></a></li>
                        <li class="twitter social-icon"><a
                                href="https://twitter.com/share?url=<?php echo esc_url(the_permalink($atts['shortcode'])); ?>" onclick="javascript:window.open(this.href,
                      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=260,width=600');return false;"
                                class="product_share_twitter"><i class="fa fa-twitter"></i></a></li>
                        <li class="googleplus social-icon"><a
                                href="https://plus.google.com/share?url=<?php echo esc_url(the_permalink($atts['shortcode'])); ?>" onclick="javascript:window.open(this.href,
                      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i
                                    class="fa fa-google-plus"></i></a></li>
                        <li class="pinterest social-icon"><a
                                href="http://pinterest.com/pin/create/button/?url=<?php echo esc_url(the_permalink($atts['shortcode'])); ?>&media=<?php if (function_exists('the_post_thumbnail')) echo esc_url(wp_get_attachment_url(get_post_thumbnail_id())); ?>&description=<?php echo esc_url(get_the_title()); ?>"><i
                                    class="fa fa-pinterest"></i></a></li>
                        <li class="mail social-icon"><a
                                href="mailto:?subject=<?php echo get_the_title($atts['shortcode']); ?>&body=<?php echo strip_tags(get_the_excerpt($atts['shortcode'])); ?> <?php echo esc_url(the_permalink($atts['shortcode'])); ?>"
    ...
    } ?> wrap-gallery-content gallery-carousel">
