 ...
 * representing the CSS structure by `ScssCompiler`. The CSS tree is fed into a
 ...
 *
 * The `parse` function of `ScssCompiler` is the entry point.
 *
 * In summary:
 *
 * The `ScssCompiler` class creates an instance of the parser, feeds it SCSS code,
...
class scss_parser {
	 ...
	 *
	 * Consider the function ScssCompiler::keyword(). (All parse functions are
	 * structured the same.)
	 *
	 ...
	 *
	 * All of these parse functions are powered by ScssCompiler::match(), which behaves
	 ...
	 * avoid this, ScssCompiler::seek() is used to remember and set buffer positions.
	 *
	...
	protected function selectorSingle(&$out) {
		...
		while (true) {
			...
			// self
			if ($this->literal("&", false)) {
				$parts[] = ScssCompiler::$selfSelector;
				continue;
			}
