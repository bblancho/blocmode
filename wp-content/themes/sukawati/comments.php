...
<div id="comments" class="comment-wrapper">
    ...
    <?php if ( have_comments() ) : ?>
        <h3 class="heading">
            <?php printf ( _n ( 'Discussion about this %1$s', '%2$s Discussion to this %1$s', get_comments_number(), 'sukawati' ) , $post->post_type, number_format_i18n(get_comments_number()) ); ?>
        </h3>
    ...
    <?php if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
        <p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'sukawati' ); ?></p>
    <?php endif; ?>
