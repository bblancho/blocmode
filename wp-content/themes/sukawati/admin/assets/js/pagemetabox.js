    ...
    $(document).ready(function(){
        ...
        var page_metabox_visibililty = function() {
            ...
            if (template === 'template-home.php' ) {
                ...
                $("#jeg_slider_metabox, #jeg_popularpost_metabox, #jeg_blogcontent_metabox, #jeg_sidebar_metabox, #jeg_landingbanner_metabox").show();
            } else if ( template === 'default' ) {
                $('#jeg_slider_metabox, #jeg_popularpost_metabox, #jeg_blogcontent_metabox, #jeg_sidebar_metabox, #jeg_landingbanner_metabox').hide();
