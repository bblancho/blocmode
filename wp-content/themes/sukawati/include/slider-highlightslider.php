<?php
    ...
    add_filter('excerpt_length', 'sukawati_slider_excerpt');
        ...
        <div class="container">
            <div class="flexslider">
                ...
                <?php while ( $query->have_posts() ) : $query->the_post(); if (has_post_thumbnail()) : ?>
                    <li>
                        <article>
                            <a href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'sukawati-featured' ); ?></a>
                            <div class="slide-overlay">
                                <div class="slider-excerpt">
                                    <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                                    <div class="line"></div>
                                    <?php the_excerpt(); ?>
                                    <a class="readmore" href="<?php the_permalink() ?>"><?php esc_html_e( 'Read More', 'sukawati' ); ?></a>
                                </div>
                            </div>
                        </article>
                    </li>
...
<?php
    ...
    remove_filter('excerpt_length', 'sukawati_slider_excerpt');
