 ...
 * ------------------------------------------------------------------------- */
function sukawati_register_theme_customizer($wp_customize) {
    ...
    locate_template(array('/lib/customizer/options/header6.php'),    true, true); #8
    locate_template(array('/lib/customizer/options/mobile.php'),     true, true); #9
    locate_template(array('/lib/customizer/options/sidebar.php'),    true, true); #10
    locate_template(array('/lib/customizer/options/footer.php'),     true, true); #11
    locate_template(array('/lib/customizer/options/background.php'), true, true); #12
}
add_action( 'customize_register', 'sukawati_register_theme_customizer' );
...
if (class_exists('WP_Customize_Control')) {
     ...
     * New Upload Control
     */
    class Sukawati_Customize_Newupload_Control extends WP_Customize_Control {
        public $type = 'newupload';

        public function enqueue(){
            wp_enqueue_media();
            wp_enqueue_style ('sukawati-theme-customizer-style', get_template_directory_uri() . '/lib/customizer/css/customizer.css', null, SUKAWATI_VERSION);
            wp_enqueue_script('sukawati-newupload', get_template_directory_uri() . '/lib/customizer/js/newupload.js' , null, null, true);
        }
     ...
     * Flag control
     */
    class Sukawati_Customize_Flag_Control extends WP_Customize_Control {
        public $type = 'flag';

        public function enqueue(){
            wp_enqueue_style ('sukawati-theme-customizer-style', get_template_directory_uri() . '/lib/customizer/css/customizer.css', null, SUKAWATI_VERSION);
            wp_enqueue_script('sukawati-additional-script', get_template_directory_uri() . '/lib/customizer/js/customizer-additional.js' , null, null, true);
        }
     ...
     * Slider control
     ***/
    class Sukawati_Customize_Slider_Control extends WP_Customize_Control {
        public $type = 'slider';
        public $min, $max, $step;
     ...
     * Textarea control
     */
    class Sukawati_Customize_Textarea_Control extends WP_Customize_Control {
     ...
     * Sub Title
     */
    class Sukawati_Customize_Subtitle_Control extends WP_Customize_Control {
 ...
 * ------------------------------------------------------------------------- */
class Sukawati_Customizer_Framework {
    private $section;
    private $setting;
    ...
    public function customizer_newupload($sectionname, $setting, $wp_customize, $id) {
        $wp_customize->add_setting( $setting['name'], array(
            ...
            'sanitize_callback' => 'sukawati_sanitize_callback_dummy'
        ));
        $wp_customize->add_control( new Sukawati_Customize_Newupload_Control($wp_customize, $setting['name'], array(
            'section'   => $sectionname,
            'label'     => $setting['title'],
    ...
    public function customizer_textarea($sectionname, $setting, $wp_customize, $id) {
        ...
        $wp_customize->add_control( new Sukawati_Customize_Textarea_Control($wp_customize, $setting['name'], array(
            'section'   => $sectionname,
            'label'     => $setting['title'],
            'settings'  => $setting['name'],
            'priority'  => $id,
    ...
    public function customizer_subtitle($sectionname, $setting, $wp_customize, $id) {
        ...
        $wp_customize->add_control( new Sukawati_Customize_Subtitle_Control($wp_customize, $setting['name'], array(
            'section'   => $sectionname,
            'label'     => $setting['title'],
            'settings'  => $setting['name'],
    ...
    public function customizer_flag ($sectionname, $setting, $wp_customize, $id) {
        ...
        $wp_customize->add_control( new Sukawati_Customize_Flag_Control($wp_customize, $setting['name'], array(
            'section'   => $sectionname,
            'label'     => $setting['title'],
            'settings'  => $setting['name'],
            'priority'  => $id
    ...
    public function customizer_slider($sectionname, $setting, $wp_customize, $id) {
        ...
        $wp_customize->add_control( new Sukawati_Customize_Slider_Control($wp_customize, $setting['name'], array(
            'section'   => $sectionname,
            'label'     => $setting['title'],
            'settings'  => $setting['name'],
            'priority'  => $id,
...
function sukawati_sanitize_callback_dummy( $value ) {
    return $value;
}