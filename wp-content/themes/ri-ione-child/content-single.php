...
?>
    <div class="container">
        ...
        <div class='content_produit'>
            ...
            <div class="wrap-price">
                <p class="price"> 
                    ...
                    <?php if( !empty($data_products['_prix_solde']) ) { ?>
                        ...
                        <ins>
                            <?php echo $data_products['_prix_solde'] ." € <br/>" ; ?>
                        </ins> 
            ...
            <article class= 'description_produit_shopstyle' id="post-<?php the_ID(); ?>" <?php (is_single()) ? post_class() : post_class('post-item'); ?> >   
                ...
                <?php
                    if (get_theme_mod('rit_social_sharing') != '1') {
                        get_template_part('single', 'section'); // On inclut les réseaux sociaux
                    }
                ?>
            </article><!-- #post-## -->
        </div>
