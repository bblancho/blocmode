    ...
    foreach ($tab_id_shopstyle as  $id_liste) {
        ...
        if ( $tab_format_json_article === true ) {
            ...
            foreach ($tab_articles_shopstyle as $article) {
               ...
               'post_content'=> "ion et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500, quand un peintre anonyme assembla ensemble des",
               'post_title'=> 'DONNA KARAN - SWEAT À LOGO',
               'post_excerpt'=>"ion et la mise en page avant impression.",
               'post_status'=>'publish', 
                'comment_status'=>'open',
                'ping_status'=>'closed',
                'post_password'=>'',
