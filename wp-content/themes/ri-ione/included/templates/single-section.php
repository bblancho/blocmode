<div class="single-section clearfix">
    <div class="pull-left primary-font">
        <ul class="about-post">
            <li class="author-post"><?php esc_html_e('By ','ri-ione'); the_author_posts_link(); ?><span> - </span></li>
            <li class="date-post"> <?php the_date();?> <span> - </span></li>
            <li class="total-cmt"><a href="<?php esc_url(get_the_permalink()); ?>#comments"  class="post-comment">
                <?php comments_number( esc_html__('Write comment','ri-ione'), esc_html__('1 comment','ri-ione'), esc_html__('% comment','ri-ione') ); ?>
            </a>
            </li>
        </ul>
    </div>
