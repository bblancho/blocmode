...
<div id="top-cart">
    <div class="wrap-icon-cart">
        ...
        <?php echo sprintf(_n('<span>%d</span> <label>item</label>', '<span>%d</span> <label>items</label>', esc_html(WC()->cart->get_cart_contents_count()), 'ri-ione'), esc_html(WC()->cart->get_cart_contents_count())); ?>
    </span>
        <span
