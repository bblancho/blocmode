...
add_action('widgets_init', 'rit_aboutme');

function rit_aboutme()
{
    register_widget('rit_aboutme_widget');
}
...
if (function_exists('rit_js_enqueue')) {
    ...
    add_action('admin_enqueue_scripts', 'rit_js_enqueue');
}

class rit_aboutme_widget extends WP_Widget
{
    ...
    {
        /* Widget settings. */
        $widget_ops = array('classname' => 'aboutme_widget', 'description' => esc_html__('About me widget. Help make information for author is easy.', 'ri-ione'));

        /* Widget control settings. */
        $control_ops = array('width' => 250, 'height' => 350, 'id_base' => 'aboutme_widget');

        /* Create the widget. */
        parent::__construct('aboutme_widget', esc_html__('RIT: About me', 'ri-ione'), $widget_ops, $control_ops);
    }
    ...
    function form($instance)
    {
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'ri-ione'); ?></label>
        ...
        <p id="<?php echo esc_attr($this->get_field_id('image') . '-wrapp'); ?>">
            <label
                for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Image:', 'ri-ione'); ?></label>
            ...
            <input type="button" class="button button-primary custom_media_button"
                   ...
                   value="<?php esc_attr_e('Select Image', 'ri-ione') ?>"/>
        </p>
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Name:', 'ri-ione'); ?></label>
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('caption')); ?>"><?php esc_html_e('Caption:', 'ri-ione'); ?></label>
        ...
        <p id="<?php echo esc_attr($this->get_field_id('sign') . '-wrapp'); ?>">
            <label
                for="<?php echo esc_attr($this->get_field_id('sign')); ?>"><?php esc_html_e('Sign Image:', 'ri-ione'); ?></label>
            ...
            <input type="button" class="button button-primary custom_media_button"
                   ...
                   value="<?php esc_attr_e('Select Sign', 'ri-ione') ?>"/>
        </p>
