...
<div class="wrap-login" id="customer_login">
        ...
        <form method="post" class="login">
            ...
            <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username"
                       id="username" placeholder="<?php esc_attr_e('Username or email address', 'woocommerce'); ?> *"
                       value="<?php if (!empty($_POST['username'])) echo esc_attr($_POST['username']); ?>"/>
            </p>
            <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                <input class="woocommerce-Input woocommerce-Input--text input-text" placeholder="<?php esc_attr_e('Password', 'woocommerce'); ?> *" type="password" name="password"
                       id="password"/>
            </p>
            ...
            <?php if (get_option('woocommerce_enable_myaccount_registration') === 'yes'){ ?>
                <a href="#" class="btn btn-show-register light" title="<?php esc_attr_e('Create New Account', 'ri-ione'); ?>"><?php esc_html_e('Create New Account', 'ri-ione'); ?></a>
                <?php
            } ?>
        </form>
    ...
    <div class="register form" style="display:none">
        ...
        <form method="post" class="register">
            ...
            <a href="#" class="btn btn-show-login light" title="<?php esc_attr_e('Sign In', 'ri-ione'); ?>"><?php esc_html_e('Sign In', 'ri-ione'); ?></a>
        </form>
