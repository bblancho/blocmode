                ...
                <div id="detail-post" class="content-single <?php echo esc_attr($rit_class_main); ?>">
                    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <div class="post-image single-image">
                            <?php
                            $rit_image_size = apply_filters('ri_ione_attachment_size', 'full');
                        ...
                        <div class="post-content">
                            ...
                            the_content();
                            wp_link_pages(array(
                                'before' => '<div class="page-links"><span class="page-links-title">' . esc_html(__('Pages:', 'ri-ione')) . '</span>',
                                'after' => '</div>',
                                'link_before' => '<span>',
                                'link_after' => '</span>',
                                'pagelink' => '<span class="screen-reader-text">' . esc_html(__('Page', 'ri-ione')) . ' </span>%',
                        ...
                        <nav id="image-navigation" class="post-pagination  row">
                            <div class="prev-post col-sm-6 col-xs-12">
                                <h4>
                                    <?php previous_image_link(false, esc_html(__('Previous Image', 'ri-ione'))); ?>
                                </h4>
                            </div>
                            <div class="next-post col-sm-6 col-xs-12">
                                <h4>
                                    <?php next_image_link(false, esc_html(__('Next Image', 'ri-ione'))); ?>
                                </h4>
                            </div>
