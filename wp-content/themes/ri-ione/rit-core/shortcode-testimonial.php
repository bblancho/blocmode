...
$wrapID = 'testimonial_block_' . rit_random_ID();
...
<div id="<?php echo esc_attr($wrapID) ?>"
     class="rit-testimonial-shortcode rit-testimonial <?php echo esc_attr($atts['el_class']);
     echo esc_attr($atts['style']) . '-testimonial' ?>">
<?php
...
if ($the_query->have_posts()):
    ...
    <div class="rit-wrapper-testimonial-block <?php if ($atts['style'] == 'carousel') {
        echo esc_attr('ri-ione-carousel');
    } ?>"
        <?php if ($atts['style'] == 'carousel') { ?> data-config=' <?php echo esc_attr($jsconfig); ?> ' <?php } ?>>
        <?php
        while ($the_query->have_posts()):$the_query->the_post();
            ?>
            <article id="testimonial-<?php the_ID(); ?>" <?php echo post_class('rit-testimonial-item ' . $class) ?>>
                ...
                <div class="rit-wrap-author">
                    ...
                    <div class="rit-wrap-author-info">
                        ...
                        if (get_post_meta(get_the_ID(), 'rit_author', true) != '') { ?>
                            <h4 class="rit-testimonial-author"><?php
